...
dependencies {
    ...
    // implementation(libs.thprofparser)
}
...
publishing {
    ...
    publications {
        ...
        with(defaultPublication) {
            ...
            pom {
                name = "tHprofParser"
                description = "Parse jvm memory dump hprof file."
                url = "https://github.com/tans5/tHprofParser.git"
                licenses {
                    license {
                ...
                scm {
                    url.set("https://github.com/tans5/tHprofParser.git")
                }
            }
